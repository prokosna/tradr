...
## Next three actions
1. **`WI-M6-004`, the three linking messages**, now that DCR-067 has assigned their type bytes and said what stream carries them. It is the next one that depends on nothing unsettled: `proto/`, `0x0c`-`0x0e`, and the codec in `tradr-proto`
