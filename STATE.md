...
**`WI-M6-003`, on `wi-m6-003-link-registry`.** DCR-069 is committed ahead of it and the Supervisor's Critical Module tests are written before dispatch, per section 6.
